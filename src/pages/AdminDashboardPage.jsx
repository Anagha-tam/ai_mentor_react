        ...
        {activeTab === "invitations" ? (
                ...
                <div className="adm-card">
                  ...
                  <div className="adm-activity-list">
                    {candidateRows.slice(0, 6).map((row) => {
                      ...
                      const title =
                        st === "completed"
                          ? `${row.candidateName || row.email} completed mentoring`
                          : st === "inprogress"
                      ...
                      const meta =
                        st === "completed"
                          ...
                          : st === "inprogress"
                            ...
                            : `${formatAgo(row.lastInvitedAt)} · AI Mentor · Pending`;
                      return (
          ...
          <>
            ...
            <div className="adm-stats-grid">
              ...
              <div className="adm-stat-card">
                <div className="adm-stat-label">Avg mentoring time</div>
          ...
          <>
            <div className="adm-stats-grid">
              ...
              >
                <div className="adm-stat-label">Started mentoring</div>
              ...
              >
                <div className="adm-stat-label">Completed mentoring</div>
